...
import { GoalsClient } from '../support/api/clients/GoalsClient';
...
import { SeededUser, seedUser } from '../support/api/users/seedUser';
...
function extractToken(body: Record<string, unknown>): string | undefined {
  const direct = (body.token as string | undefined) ?? (body.accessToken as string | undefined);
